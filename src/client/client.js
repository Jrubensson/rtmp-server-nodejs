...
const NMRtmpHandshake = require('./handshake')
...
const MESSAGE_TYPE_IDS = {
  SET_PACKET_SIZE_MESSAGE: 0x01,
  PING_MESSAGE: 0x04,
...
class NMRtmpConn extends EventEmitter {
  ...
  stop () {
    ...
    if (this.publishStreamName !== '') {
      // console.info("Send Stream EOF to publisher's consumers. Stream name " + this.publishStreamName);
